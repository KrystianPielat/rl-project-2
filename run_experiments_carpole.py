...
if __name__ == "__main__":
    ...
    configurations = {
        # 1. Full observability baseline
        "full_observability": [],
        # 2. Partial observability only (remove ẋ and θ̇)
        "partial_observability": [
            (FeatureFilterWrapper, [3], {}),  # remove angular velocity (example)
            (FeatureFilterWrapper, [2], {}),  # remove x velocity (after index shift)
        ],
        # 3. Partial observability + observation memory
        "partial_obs+memory": [
            (ObsTimeExtensionWrapper, [], {}),
            (FeatureFilterWrapper, [3], {}),
            (FeatureFilterWrapper, [2], {}),
        ],
        # 4. Partial observability + action extension
        "partial_obs+chunked_actions": [
            (ActionTimeExtensionWrapper, [], {"num_actions": 3}),
            (FeatureFilterWrapper, [3], {}),
            (FeatureFilterWrapper, [2], {}),
        ],
        # 5. Partial observability + both extensions
        "partial_obs+memory+chunked_actions": [
            (ObsTimeExtensionWrapper, [], {}),
            (ActionTimeExtensionWrapper, [], {"num_actions": 3}),
            (FeatureFilterWrapper, [3], {}),
            (FeatureFilterWrapper, [2], {}),
